...
from dbt.adapters.databricksnb.relation_configs.tags import TagsProcessor
from dbt.adapters.databricksnb.relation_configs.tblproperties import TblPropertiesProcessor
