...
from dbt.adapters.databricksnb.relation_configs.comment import (
    CommentProcessor,
)
from dbt.adapters.databricksnb.relation_configs.partitioning import (
    PartitionedByProcessor,
)
from dbt.adapters.databricksnb.relation_configs.query import (
    QueryProcessor,
)
from dbt.adapters.databricksnb.relation_configs.refresh import (
    RefreshProcessor,
)
from dbt.adapters.databricksnb.relation_configs.tblproperties import (
