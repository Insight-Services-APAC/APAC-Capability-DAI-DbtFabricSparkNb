...
$workspaceName = '4f0cb887-047a-48a1-98c3-ebdb38c784c2'
...
& azcopy copy "https://onelake.blob.fabric.microsoft.com/$workspacename/$itemPath/MetaExtracts/" "./testproj/" --overwrite=true --recursive --trusted-microsoft-suffixes=onelake.blob.fabric.microsoft.com --log-level=INFO;
